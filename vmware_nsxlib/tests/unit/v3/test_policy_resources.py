...
class TestPolicyLBClientSSLProfileApi(NsxPolicyLibTestCase):
    ...
    def setUp(self, *args, **kwargs):
        ...
        self.resourceApi = self.policy_lib.loadbalancer.lb_client_ssl_profile
    ...
    def test_create_with_id(self):
        ...
        with mock.patch.object(self.policy_api,
            ...
            self.resourceApi.create_or_overwrite(
                name,
                lb_client_ssl_profile_id=id,
                description=description,
                protocols=protocols,
                tenant=TEST_TENANT)
            expected_def = policy_defs.LBClientSslProfileDef(
                lb_client_ssl_profile_id=id,
                name=name,
                description=description,
                protocols=protocols,
    ...
    def test_create_without_id(self):
        ...
        with mock.patch.object(self.policy_api,
            ...
            self.resourceApi.create_or_overwrite(name, description=description,
                                                 tenant=TEST_TENANT)
            expected_def = policy_defs.LBClientSslProfileDef(
                lb_client_ssl_profile_id=mock.ANY,
                name=name,
                description=description,
                tenant=TEST_TENANT)
            self.assert_called_with_def(api_call, expected_def)
...
class TestPolicyLBCookiePersistenceProfile(NsxPolicyLibTestCase):
    ...
    def setUp(self, *args, **kwargs):
        ...
        self.resourceApi =\
            self.policy_lib.loadbalancer.lb_cookie_persistence_profile
    ...
    def test_create_with_id(self):
        ...
        with mock.patch.object(self.policy_api,
            ...
            self.resourceApi.create_or_overwrite(
                name,
                lb_cookie_persistence_profile_id=id,
                description=description,
                ...
                tenant=TEST_TENANT)
            expected_def = policy_defs.LBCookiePersistenceProfileDef(
                lb_cookie_persistence_profile_id=id,
                name=name,
                description=description,
                cookie_name=cookie_name,
    ...
    def test_create_without_id(self):
        ...
        with mock.patch.object(self.policy_api,
            ...
            self.resourceApi.create_or_overwrite(name, description=description,
                                                 tenant=TEST_TENANT)
            expected_def = policy_defs.LBCookiePersistenceProfileDef(
                lb_cookie_persistence_profile_id=mock.ANY,
                name=name,
                description=description,
                tenant=TEST_TENANT)
            self.assert_called_with_def(api_call, expected_def)
...
class TestPolicyLBSourceIpProfileApi(NsxPolicyLibTestCase):
    ...
    def setUp(self, *args, **kwargs):
        ...
        self.resourceApi =\
            self.policy_lib.loadbalancer.lb_source_ip_persistence_profile
    ...
    def test_create_with_id(self):
        ...
        with mock.patch.object(self.policy_api,
            ...
            self.resourceApi.create_or_overwrite(
                name,
                lb_source_ip_persistence_profile_id=id,
                description=description,
                ...
                timeout=timeout,
                tenant=TEST_TENANT)
            expected_def = policy_defs.LBSourceIpPersistenceProfileDef(
                lb_source_ip_persistence_profile_id=id,
                name=name,
                description=description,
                ha_persistence_mirroring_enabled=
    ...
    def test_create_without_id(self):
        ...
        with mock.patch.object(self.policy_api,
            ...
            self.resourceApi.create_or_overwrite(name, description=description,
                                                 tenant=TEST_TENANT)
            expected_def = policy_defs.LBSourceIpPersistenceProfileDef(
                lb_source_ip_persistence_profile_id=mock.ANY,
                name=name,
                description=description,
                tenant=TEST_TENANT)
            self.assert_called_with_def(api_call, expected_def)
...
class TestPolicyLBService(NsxPolicyLibTestCase):
    ...
    def setUp(self, *args, **kwargs):
        ...
        self.resourceApi = self.policy_lib.loadbalancer.lb_service
...
class TestPolicyLBVirtualServer(NsxPolicyLibTestCase):
    ...
    def test_delete(self):
        ...
        with mock.patch.object(self.policy_api, "delete") as api_call:
            self.resourceApi.delete(id, tenant=TEST_TENANT)
            expected_def = policy_defs.LbVirtualServerDef(virtual_server_id=id,
                                                          tenant=TEST_TENANT)
            self.assert_called_with_def(api_call, expected_def)
...
class TestPolicyLBPoolApi(NsxPolicyLibTestCase):
    ...
    def setUp(self, *args, **kwargs):
        ...
        self.resourceApi = self.policy_lib.loadbalancer.lb_pool
