...
class TestPolicyIpPool(NsxPolicyLibTestCase):
    ...
    def test_create_or_update_static_subnet(self):
        ...
        cidr = '10.10.10.0/24'
        ip_range = self.resourceApi.build_ip_range(
            '10.10.10.2', '10.10.10.250')

        with mock.patch.object(self.policy_api,
                               "create_or_update") as api_call:
            self.resourceApi.create_or_update_static_subnet(
                ip_pool_id, cidr, [ip_range], ip_subnet_id, tenant=TEST_TENANT)
    ...
    def test_list_static_subnet(self):
        ...
        with mock.patch.object(self.policy_api, "list") as api_call:
            self.resourceApi.list_static_subnets(
