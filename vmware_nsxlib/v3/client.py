...
class RESTClient(object):
    ...
    def delete(self, uuid, headers=None, excepeted_results=None):
        return self.url_delete(uuid, headers=headers,
                               excepeted_results=excepeted_results)

    def update(self, uuid, body=None, headers=None, excepeted_results=None):
        return self.url_put(uuid, body, headers=headers,
                            excepeted_results=excepeted_results)

    def create(self, resource='', body=None, headers=None,
               excepeted_results=None):
    ...
    def url_delete(self, url, headers=None, excepeted_results=None):
        return self._rest_call(url, method='DELETE', headers=headers,
                               excepeted_results=excepeted_results)

    def url_put(self, url, body, headers=None, excepeted_results=None):
        return self._rest_call(url, method='PUT', body=body, headers=headers,
                               excepeted_results=excepeted_results)

    def url_post(self, url, body, headers=None, excepeted_results=None):
    ...
    def _rest_call(self, url, method='GET', body=None, headers=None,
                   silent=False, excepeted_results=None):
        ...
        if not excepeted_results:
            excepeted_results = RESTClient._VERB_RESP_CODES[method.lower()]
        self._validate_result(
            result, excepeted_results,
