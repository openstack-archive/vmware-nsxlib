...
# TODO(annak): for create/delete operations, configure client to
# use admin password auth rather than client cert auth
class NsxLibTrustManagement(utils.NsxLibApiBase):
    ...
    def delete_identity(self, identity):
        # TODO(annak) - add extra header to enable deletion if needed
