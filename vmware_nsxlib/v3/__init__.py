...
class NsxPolicyLib(NsxLibBase):
    ...
    def init_api(self):
        ...
        # TODO(asarfaty): consider using allow_overwrite_header=True here
        ...
        self.enforcement_point = policy_resources.NsxPolicyEnforcementPointApi(
            *args)
        self.transport_zone = policy_resources.NsxPolicyTransportZoneApi(*args)
        self.deployment_map = policy_resources.NsxPolicyDeploymentMapApi(*args)
