...
class LoadBalancerBase(utils.NsxLibApiBase):
    ...
    @staticmethod
    def _build_args(display_name, description, tags, resource_type, **kwargs):
        body = dict()
        if display_name:
    ...
    def create(self, display_name=None, description=None, tags=None,
        ...
        body = self._build_args(display_name, description, tags,
...
class ApplicationProfile(LoadBalancerBase):
    ...
    @staticmethod
    def _build_args(display_name, description, tags, resource_type,
                    **kwargs):
        body = dict()
        if display_name:
            body['display_name'] = display_name
...
class PersistenceProfile(LoadBalancerBase):
    ...
    @staticmethod
    def _build_args(display_name, description, resource_type, tags,
                    **kwargs):
        body = dict()
        if display_name:
            body['display_name'] = display_name
