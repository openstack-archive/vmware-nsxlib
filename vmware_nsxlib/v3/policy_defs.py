...
class CommunicationMapDef(ResourceDef):
    ...
    def update_attributes_in_body(self, body, **kwargs):
        ...
        super(CommunicationMapDef, self).update_attributes_in_body(
            body, **kwargs)
...
class DeploymentMapDef(ResourceDef):
    ...
    def __init__(self, map_id=None,
        ...
        self.ep_path = EnforcementPointDef(ep_id).get_resource_full_path()
        self.name = name
        self.domain_path = DomainDef(domain_id).get_resource_full_path()
        self.tenant = tenant
        self.description = None
        self.parent_ids = (tenant)
