...
class NsxLibFirewallSection(utils.NsxLibApiBase):
    ...
    def create(self, display_name, description, applied_tos, tags=[],
    ...
    def get_rule_address(self, target_id, display_name=None,
                         is_valid=True, target_type=const.TARGET_TYPE_IPV4ADDRESS):
