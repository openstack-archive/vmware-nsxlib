...
class NsxPolicyIpPoolApi(NsxPolicyResourceBase):
    ...
    def _get_subnet_attr_from_realized_info(self, realized_info,
                                            requested_attr):
        if realized_info:
            try:
                for attr in realized_info['extended_attributes']:
    ...
    def get_ip_block_subnet_cidr(self, ip_pool_id, ip_subnet_id,
        ...
        return self._get_subnet_attr_from_realized_info(
