...
# IPSEC VPN IKE LOG levels
IPSEC_IKE_LOG_LEVEL_DEBUG = 'DEBUG'
IPSEC_IKE_LOG_LEVEL_INFO = 'INFO'
IPSEC_IKE_LOG_LEVEL_WARN = 'WARN'
IPSEC_IKE_LOG_LEVEL_ERROR = 'ERROR'
IPSEC_IKE_LOG_LEVEL_ERROR = 'EMERGENCY'
