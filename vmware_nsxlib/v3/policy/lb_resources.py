...
class NsxPolicyLBMonitorProfileHttpApi(NsxPolicyLBMonitorProfileBase):
    ...
    def create_or_overwrite(self,
        ...
        super(NsxPolicyLBMonitorProfileHttpApi, self).create_or_overwrite(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
    ...
    def update(self,
               ...
               request_body=IGNORE,
               response_status_codes=IGNORE):
        super(NsxPolicyLBMonitorProfileHttpApi, self).update(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
...
class NsxPolicyLBMonitorProfileHttpsApi(NsxPolicyLBMonitorProfileBase):
    ...
    def create_or_overwrite(self,
                            ...
                            request_body=IGNORE,
                            response_status_codes=IGNORE):
        super(NsxPolicyLBMonitorProfileHttpsApi, self).create_or_overwrite(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
    ...
    def update(self,
               ...
               request_body=IGNORE,
               response_status_codes=IGNORE):
        super(NsxPolicyLBMonitorProfileHttpsApi, self).update(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
...
class NsxPolicyLBMonitorProfileUdpApi(NsxPolicyLBMonitorProfileBase):
    ...
    def create_or_overwrite(self,
                            ...
                            receive=IGNORE,
                            send=IGNORE):
        super(NsxPolicyLBMonitorProfileUdpApi, self).create_or_overwrite(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
    ...
    def update(self,
               ...
               receive=IGNORE,
               send=IGNORE):
        super(NsxPolicyLBMonitorProfileUdpApi, self).update(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
...
class NsxPolicyLBMonitorProfileIcmpApi(NsxPolicyLBMonitorProfileBase):
    ...
    def create_or_overwrite(self,
                            ...
                            fall_count=IGNORE,
                            rise_count=IGNORE):
        super(NsxPolicyLBMonitorProfileIcmpApi, self).create_or_overwrite(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
    ...
    def update(self,
               ...
               fall_count=IGNORE,
               rise_count=IGNORE):
        super(NsxPolicyLBMonitorProfileIcmpApi, self).update(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
...
class NsxPolicyLBMonitorProfileTcpApi(NsxPolicyLBMonitorProfileBase):
    ...
    def create_or_overwrite(self,
                            ...
                            rise_count=IGNORE,
                            monitor_port=IGNORE):
        super(NsxPolicyLBMonitorProfileTcpApi, self).create_or_overwrite(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
    ...
    def update(self,
               ...
               rise_count=IGNORE,
               monitor_port=IGNORE):
        super(NsxPolicyLBMonitorProfileTcpApi, self).update(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
