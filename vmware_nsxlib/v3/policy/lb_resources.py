...
class NsxPolicyLBMonitorProfileHttpApi(NsxPolicyLBMonitorProfileBase):
    ...
    def create_or_overwrite(self,
        ...
        super(NsxPolicyLBMonitorProfileHttpApi).create_or_overwrite(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
    ...
    def update(self,
               ...
               request_body=IGNORE,
               response_status_codes=IGNORE):
        super(NsxPolicyLBMonitorProfileHttpApi).update(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
...
class NsxPolicyLBMonitorProfileHttpsApi(NsxPolicyLBMonitorProfileBase):
    ...
    def create_or_overwrite(self,
                            ...
                            request_body=IGNORE,
                            response_status_codes=IGNORE):
        super(NsxPolicyLBMonitorProfileHttpsApi).create_or_overwrite(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
    ...
    def update(self,
               ...
               request_body=IGNORE,
               response_status_codes=IGNORE):
        super(NsxPolicyLBMonitorProfileHttpsApi).update(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
...
class NsxPolicyLBMonitorProfileUdpApi(NsxPolicyLBMonitorProfileBase):
    ...
    def create_or_overwrite(self,
                            ...
                            receive=IGNORE,
                            send=IGNORE):
        super(NsxPolicyLBMonitorProfileUdpApi).create_or_overwrite(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
    ...
    def update(self,
               ...
               receive=IGNORE,
               send=IGNORE):
        super(NsxPolicyLBMonitorProfileUdpApi).update(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
...
class NsxPolicyLBMonitorProfileIcmpApi(NsxPolicyLBMonitorProfileBase):
    ...
    def create_or_overwrite(self,
                            ...
                            fall_count=IGNORE,
                            rise_count=IGNORE):
        super(NsxPolicyLBMonitorProfileIcmpApi).create_or_overwrite(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
    ...
    def update(self,
               ...
               fall_count=IGNORE,
               rise_count=IGNORE):
        super(NsxPolicyLBMonitorProfileIcmpApi).update(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
...
class NsxPolicyLBMonitorProfileTcpApi(NsxPolicyLBMonitorProfileBase):
    ...
    def create_or_overwrite(self,
                            ...
                            rise_count=IGNORE,
                            monitor_port=IGNORE):
        super(NsxPolicyLBMonitorProfileTcpApi).create_or_overwrite(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
    ...
    def update(self,
               ...
               rise_count=IGNORE,
               monitor_port=IGNORE):
        super(NsxPolicyLBMonitorProfileTcpApi).update(
            lb_monitor_profile_id=lb_monitor_profile_id,
            tags=tags,
            tenant=tenant,
            display_name=display_name,
