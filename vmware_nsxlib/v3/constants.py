...
# Supported strict ICMP types and their codes. MP will accepts everything except 9-16
IPV4_ICMP_STRICT_TYPES = IPV4_ICMP_TYPES.copy()
# Note: replace item 9 instead of removing 16 from codes as we did a shallow copy
