...
class NsxCommunicationProfileApi(NsxPolicyResourceBase):
...
class NsxCommunicationMapApi(NsxPolicyResourceBase):
    ...
    def get_by_name(self, domain_id, name,
        ...
        return super(NsxCommunicationMapApi, self).get_by_name(
