...
class NsxPolicyLoadBalancerLBHttpProfileApi(NsxPolicyResourceBase):
    """NSX Policy Lb app profile"""

    @property
    def entry_def(self):
        return policy_defs.LBHttpProfileDef

    def create_or_overwrite(self, name,
                            lb_http_profile_id=None,
                            description=IGNORE,
                            ...
                            tags=IGNORE,
                            tenant=policy_constants.POLICY_INFRA_TENANT):
        print("hey", idle_timeout)
        lb_http_profile_id = self._init_obj_uuid(lb_http_profile_id)
        lb_app_profile_def = self._init_def(
            lb_http_profile_id=lb_http_profile_id,
            name=name,
            description=description,
            ...
            tags=tags,
            tenant=tenant)
        print(lb_app_profile_def.body, lb_app_profile_def.get_obj_dict())
        self.policy_api.create_or_update(lb_app_profile_def)
        return lb_http_profile_id

    def delete(self, lb_http_profile_id,
               tenant=policy_constants.POLICY_INFRA_TENANT):
    ...
    def get(self, lb_http_profile_id,
            tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_app_profile_def = self.entry_def(
            lb_http_profile_id=lb_http_profile_id,
            tenant=tenant)
    ...
    def update(self, lb_http_profile_id,
               name=IGNORE,
               description=IGNORE,
               http_redirect_to_https=IGNORE,
               http_redirect_to=IGNORE,
...
class NsxPolicyLoadBalancerLBFastTcpProfileApi(NsxPolicyResourceBase):
    """NSX Policy Lb app profile"""

    @property
    def entry_def(self):
        return policy_defs.LBFastTcpProfile

    def create_or_overwrite(self, name,
                            lb_fast_tcp_profile_id=None,
                            description=IGNORE,
                            http_redirect_to_https=IGNORE,
                            http_redirect_to=IGNORE,
                            idle_timeout=IGNORE,
                            ...
                            tags=IGNORE,
                            tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_fast_tcp_profile_id = self._init_obj_uuid(lb_fast_tcp_profile_id)
        lb_app_profile_def = self._init_def(
            lb_fast_tcp_profile_id=lb_fast_tcp_profile_id,
            name=name,
            description=description,
            http_redirect_to_https=http_redirect_to_https,
            http_redirect_to=http_redirect_to,
            ...
            tenant=tenant)
        self.policy_api.create_or_update(lb_app_profile_def)
        return lb_fast_tcp_profile_id

    def delete(self, lb_fast_tcp_profile_id,
               tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_app_profile_def = self.entry_def(
            lb_fast_tcp_profile_id=lb_fast_tcp_profile_id,
            tenant=tenant)
    ...
    def get(self, lb_fast_tcp_profile_id,
            tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_app_profile_def = self.entry_def(
            lb_fast_tcp_profile_id=lb_fast_tcp_profile_id,
            tenant=tenant)
    ...
    def update(self, lb_fast_tcp_profile_id,
               name=IGNORE,
               description=IGNORE,
               http_redirect_to_https=IGNORE,
               http_redirect_to=IGNORE,
...
class NsxPolicyLoadBalancerLBFastUdpProfileApi(NsxPolicyResourceBase):
    """NSX Policy Lb app profile"""

    @property
    def entry_def(self):
        return policy_defs.LBFastUdpProfile

    def create_or_overwrite(self, name,
                            lb_fast_udp_profile_id=None,
                            description=IGNORE,
                            http_redirect_to_https=IGNORE,
                            http_redirect_to=IGNORE,
                            idle_timeout=IGNORE,
                            ...
                            tags=IGNORE,
                            tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_fast_udp_profile_id = self._init_obj_uuid(lb_fast_udp_profile_id)
        lb_app_profile_def = self._init_def(
            lb_fast_udp_profile_id=lb_fast_udp_profile_id,
            name=name,
            description=description,
            http_redirect_to_https=http_redirect_to_https,
            http_redirect_to=http_redirect_to,
            ...
            tenant=tenant)
        self.policy_api.create_or_update(lb_app_profile_def)
        return lb_fast_udp_profile_id

    def delete(self, lb_fast_udp_profile_id,
               tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_app_profile_def = self.entry_def(
            lb_fast_udp_profile_id=lb_fast_udp_profile_id,
            tenant=tenant)
    ...
    def get(self, lb_fast_udp_profile_id,
            tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_app_profile_def = self.entry_def(
            lb_fast_udp_profile_id=lb_fast_udp_profile_id,
            tenant=tenant)
    ...
    def update(self, lb_fast_udp_profile_id,
               name=IGNORE,
               description=IGNORE,
               http_redirect_to_https=IGNORE,
               http_redirect_to=IGNORE,
...
class NsxPolicyLoadBalancerLBClientSSLProfileApi(NsxPolicyResourceBase):
    ...
    @property
    def entry_def(self):
        return policy_defs.LBClientSslProfileDef

    def create_or_overwrite(self, name,
                            lb_client_ssl_profile_id=None,
                            description=IGNORE,
                            tags=IGNORE,
                            protocols=IGNORE,
                            tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_client_ssl_profile_id = self._init_obj_uuid(
        ...
        return lb_client_ssl_profile_id

    def delete(self, lb_client_ssl_profile_id,
               tenant=policy_constants.POLICY_INFRA_TENANT):
    ...
    def get(self, lb_client_ssl_profile_id,
            tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_client_ssl_profile_def = self.entry_def(
            lb_client_ssl_profile_id=lb_client_ssl_profile_id,
            tenant=tenant)
    ...
    def update(self, lb_client_ssl_profile_id,
               name=IGNORE,
               description=IGNORE,
               tags=IGNORE,
               protocols=IGNORE,
...
class NsxPolicyLoadBalancerLBCookiePersistenceProfileApi(
    ...
    @property
    def entry_def(self):
        return policy_defs.LBCookiePersistenceProfileDef

    def create_or_overwrite(self, name,
                            lb_cookie_persistence_profile_id=None,
                            description=IGNORE,
                            tags=IGNORE,
                            ...
                            tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_cookie_persistence_profile_id = self._init_obj_uuid(
            lb_cookie_persistence_profile_id)
        lb_cookie_persistence_profile_def = self._init_def(
            lb_cookie_persistence_profile_id=lb_cookie_persistence_profile_id,
            name=name,
            description=description,
            tags=tags,
        ...
        return lb_cookie_persistence_profile_id

    def delete(self, lb_cookie_persistence_profile_id,
               tenant=policy_constants.POLICY_INFRA_TENANT):
    ...
    def get(self, lb_cookie_persistence_profile_id,
            tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_cookie_persistence_profile_def = self.entry_def(
            lb_cookie_persistence_profile_id=lb_cookie_persistence_profile_id,
            tenant=tenant)
...
class NsxPolicyLoadBalancerLBSourceIpPersistenceProfileApi(
    ...
    @property
    def entry_def(self):
        return policy_defs.LBSourceIpPersistenceProfileDef

    def create_or_overwrite(self, name,
                            lb_source_ip_persistence_profile_id=None,
                            description=IGNORE,
                            tags=IGNORE,
                            ...
                            timeout=IGNORE,
                            tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_source_ip_persistence_profile_id = self._init_obj_uuid(
            lb_source_ip_persistence_profile_id)
        ...
        return lb_source_ip_persistence_profile_id

    def delete(self, lb_source_ip_persistence_profile_id,
               tenant=policy_constants.POLICY_INFRA_TENANT):
    ...
    def get(self, lb_source_ip_persistence_profile_id,
            tenant=policy_constants.POLICY_INFRA_TENANT):
        lb_source_ip_persistence_profile_def = self.entry_def(
            lb_source_ip_persistence_profile_id=\
                lb_source_ip_persistence_profile_id,
...
class NsxPolicyLoadBalancerPoolApi(NsxPolicyResourceBase):
    ...
    def remove_monitor_from_pool(self, lb_pool_id, monitor_path,
        ...
        lb_pool = self.policy_api.get(lb_pool_def)
        monitor_paths = lb_pool.get('active_monitor_paths', [])
        monitor_paths = filter(lambda x: x!=monitor_path, monitor_paths)
        self.update(lb_pool_id, active_monitor_paths=monitor_paths)

    def update_pool_with_members(self, lb_pool_id, members):
        return self.update(lb_pool_id, members=members)

    def create_pool_member(self, ip_address, port=None,
                           display_name=None, weight=None):
        lb_pool_member = policy_defs.LBPoolMember(ip_address, port=port,
                                                  display_name=display_name,
                                                  weight=weight)
        return lb_pool_member.get_obj_dict()
    ...
    def create_pool_member_and_add_to_pool(
        ...
        lb_pool_members.append(lb_pool_member.get_obj_dict())
        self.update_pool_with_members(lb_pool_id, lb_pool_members)
        return lb_pool_member.get_obj_dict()
    ...
    def remove_pool_member(self, lb_pool_id, ip_address, port=None,
        ...
        lb_pool_members = filter(
            lambda x:x.get('ip_address')!=ip_address or x.get('port')!=port,
            lb_pool_members)
        self.update_pool_with_members(lb_pool_id, lb_pool_members)
...
class NsxPolicyLoadBalancerVirtualServerAPI(NsxPolicyResourceBase):
    ...
    def create_or_overwrite(self, name, virtual_server_id=None,
                            description=IGNORE,
                            rules=IGNORE, application_profile_path=IGNORE,
                            ip_address=IGNORE, lb_service_path=IGNORE,
                            client_ssl_profile_binding=IGNORE,
                            pool_path=IGNORE,
                            lb_persistence_profile_path=IGNORE,
                            ports=IGNORE,
                            server_ssl_profile_binding=IGNORE,
                            tenant=policy_constants.POLICY_INFRA_TENANT,
                            tags=IGNORE):
        lbvs_id = self._init_obj_uuid(virtual_server_id)
    ...
    def delete(self, virtual_server_id,
               tenant=policy_constants.POLICY_INFRA_TENANT):
        lbvs_def = self.entry_def(virtual_server_id, tenant=tenant)
        self.policy_api.delete(lbvs_def)

    def get(self, virtual_server_id,
            tenant=policy_constants.POLICY_INFRA_TENANT):
        lbvs_def = self.entry_def(
            virtual_server_id, tenant=tenant)
    ...
    def update_virtual_server_with_pool(
            self, virtual_server_id, pool_path=IGNORE):
        return self.update(virtual_server_id, pool_path=pool_path)

    def update_virtual_server_application_profile(
            self, virtual_server_id, application_profile_path=IGNORE):
        return self.update(virtual_server_id,
                           application_profile_path=application_profile_path)

    def update_virtual_server_persistence_profile(
            self, virtual_server_id, lb_persistence_profile_path=IGNORE):
        return self.update(
            virtual_server_id,
            lb_persistence_profile_path=lb_persistence_profile_path)
...
class NsxPolicyLoadBalancerApi(object):
    ...
    def __init__(self, policy_api):
        self.lb_http_profile = NsxPolicyLoadBalancerLBHttpProfileApi(
            policy_api)
        self.lb_fast_tcp_profile = NsxPolicyLoadBalancerLBFastTcpProfileApi(
            policy_api)
        self.lb_fast_udp_profile = NsxPolicyLoadBalancerLBFastUdpProfileApi(
            policy_api)
        self.lb_client_ssl_profile = \
            NsxPolicyLoadBalancerLBClientSSLProfileApi(policy_api)
        self.lb_cookie_persistence_profile = \
            NsxPolicyLoadBalancerLBCookiePersistenceProfileApi(policy_api)
        self.lb_source_ip_persistence_profile = \
            NsxPolicyLoadBalancerLBSourceIpPersistenceProfileApi(policy_api)
        self.lb_service = NsxPolicyLoadBalancerServiceApi(policy_api)
        self.virtual_server = NsxPolicyLoadBalancerVirtualServerAPI(policy_api)
        self.lb_pool = NsxPolicyLoadBalancerPoolApi(policy_api)
