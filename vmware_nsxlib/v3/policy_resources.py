...
class NsxPolicyLBApplicationProfileBase(NsxPolicyResourceBase):
...
class NsxPolicyLoadBalancerLBHttpProfileApi(NsxPolicyLBApplicationProfileBase):
    """NSX Policy Lb app profile"""
...
class NsxPolicyLoadBalancerLBFastTcpProfileApi(
    NsxPolicyLBApplicationProfileBase):
    """NSX Policy Lb app profile"""
...
class NsxPolicyLoadBalancerLBFastUdpProfileApi(
    NsxPolicyLBApplicationProfileBase):
    """NSX Policy Lb app profile"""
...
class NsxPolicyLoadBalancerVirtualServerAPI(NsxPolicyResourceBase):
    ...
    def create_lb_rule(self, virtual_server_id, actions=None,
        ...
        lb_rule = policy_defs.LbRuleDef(actions, match_conditions,
                                        display_name, match_strategy,
                                        phase)
        lbvs_def = self.entry_def(
            virtual_server_id=virtual_server_id,
            tenant=policy_constants.POLICY_INFRA_TENANT)
