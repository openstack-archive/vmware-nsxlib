...
class NsxPolicyLoadBalancerVirtualServerAPI(NsxPolicyResourceBase):
    ...
    def build_lb_rule(self, actions=None,
    ...
    def remove_lb_rule(self, virtual_server_id, lb_rule_name):
        ...
        body = self.policy_api.get(lbvs_def)
        lb_rules = body.get('rules', [])
        lb_rules = filter(lambda x: (x.get_obj_dict()['display_name'] !=
...
class NsxPolicyLoadBalancerApi(object):
    ...
    def __init__(self, policy_api):
        self.lb_http_profile = NsxPolicyLBAppProfileHttpApi(
            policy_api)
        self.lb_fast_tcp_profile = NsxPolicyLBAppProfileFastTcpApi(
            policy_api)
        self.lb_fast_udp_profile = NsxPolicyLBAppProfileFastUdpApi(
            policy_api)
