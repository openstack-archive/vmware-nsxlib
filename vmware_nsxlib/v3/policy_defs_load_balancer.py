...
from vmware_nsxlib.v3.utils import set_attr_from_id
    ...
    def get_obj_dict(self):
        ...
        if members:
            ...
            for member in members:
                ...
                if isinstance(member, LBPoolDef):
...
class LBVirtualServerDef(ResourceDef):
    ...
    def get_obj_dict(self):
        ...
        self._set_attrs_if_specified(
            body, ['application_profile_id', 'lb_persistence_profile_id',
                   'ip_address', 'lb_service_id',
                   'pool_id', 'ports'])
        ...
        set_attr_from_id(body, 'application_profile_id', 'app_profile',
                         'application_profile_path', self.get_tenant())
        set_attr_from_id(body, 'lb_persistence_profile_id',
                         'persistence_profile', 'lb_persistence_profile_path',
                         self.get_tenant())
        set_attr_from_id(body, 'lb_service_id', 'lb_service',
                         'lb_service_path', self.get_tenant())
        set_attr_from_id(body, 'pool_id', 'lb_pool',
                         'pool_path', self.get_tenant())
        return body
